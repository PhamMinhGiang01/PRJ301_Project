<%-- 
    Document   : ATech
    Created on : Mar 14, 2022, 12:41:43 AM
...
<html>
        ...
        <script type="text/javascript">
            function doDelete(id) {
                if (confirm("Are you sure to delete Brand with id = " + id + " ?")) {
                    window.location = "deletetech?id=" + id;
                }
            }
        </script>
    </head>
    <body>
        <div class="container-fluid">
            ...
            <h2><a href="addtech">Add new Technology</a></h2>
            ...
            <table border = "2px" width = "40%">
                ...
                <c:forEach items="${requestScope.list}" var="t">
                    <tr>
                        ...
                        <td>${t.getDes()}</td>
                        <td>
                            <a href="#" onclick="doDelete('${t.getId()}')" >Delete</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="updatetech?id=${t.getId()}">Update</a>
                        </td>
                    </tr>
